...
class Employee(models.Model):
    ...
    # schedule
    monday_from=models.DateField(null=True,blank=True)
    monday_to=models.DateField(null=True,blank=True)
    tuesday_from=models.DateField(null=True,blank=True)
    tuesday_to=models.DateField(null=True,blank=True)
    wenesday_from=models.DateField(null=True,blank=True)
    wenesday_to=models.DateField(null=True,blank=True)
    thursday_from=models.DateField(null=True,blank=True)
    thursday_to=models.DateField(null=True,blank=True)
    friday_from=models.DateField(null=True,blank=True)
    friday_to=models.DateField(null=True,blank=True)
    saturday_from=models.DateField(null=True,blank=True)
    saturday_to=models.DateField(null=True,blank=True)
    sunday_from=models.DateField(null=True,blank=True)
